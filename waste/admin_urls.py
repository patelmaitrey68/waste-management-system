...
urlpatterns = [
    path('',indexview.as_view(), name='admin_index'),
    ...
    path('CollectorList/', admin_views.CollectorList.as_view(), name='admin_collector_list'),
    path('approve-collector/<int:pk>/', admin_views.approve_collector, name='admin_approve_collector'),
    path('reject-collector/<int:pk>/', admin_views.reject_collector, name='admin_reject_collector'),
    path('delete-collector/<int:pk>/', admin_views.delete_collector, name='admin_delete_collector'),
    path('add_collector/', admin_views.add_collector.as_view(), name='admin_add_collector'),
    path('view_collectors/', admin_views.view_collectors.as_view(), name='admin_view_collectors'),
