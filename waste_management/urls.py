...
from waste.views import indexview,login_view,userRegistration, FeedbackView, logout_view
...
urlpatterns = [
    ...
    path('collector/register/', views.collectorRegistration.as_view(), name='collector_register'),
